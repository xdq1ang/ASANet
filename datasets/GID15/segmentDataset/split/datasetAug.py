...
dataset = DataSet(r"datasets\GID15\segmentDataset\split\train_list.txt",r"datasets\GID15\segmentDataset\split\train_list.txt",1,1,512)
dataSet = dataset.getTrainData()


new_img_path=r"datasets\GID15\segmentDataset\split\imageAug"
new_label_path=r"datasets\GID15\segmentDataset\split\labelAug"
...
for e in range(epoch):
    ...
    for i in tqdm(range(num)):
        ...
        img.save(r"datasets\GID15\segmentDataset\split\imageAug\{}.jpeg".format(new_num+1))
        label.save(r"datasets\GID15\segmentDataset\split\labelAug\{}.png".format(new_num+1)) 
