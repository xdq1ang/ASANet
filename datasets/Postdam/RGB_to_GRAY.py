...
#                 4:[0,0,255], 
#                 5:[0,255,255]}
# color_rgb = colorDict_RGB = {   0 : [255, 0, 0] ,
#                                 1 : [0, 255, 0] ,
#                                 2 : [255, 255, 0] ,
#                                 3 : [0, 0, 255] ,
#                                 4 : [0, 255, 255] ,
#                                 5 : [255, 255, 255]}
color_rgb = colorDict_RGB = {   0 : [255, 255, 255] ,
                                1 : [255, 0, 0] ,
                                2 : [0, 255, 0] ,
                                3 : [255, 255, 0] ,
                                4 : [0, 0, 255] ,
...
convertGray(r"datasets\Postdam\output\label",r"datasets\Postdam\output\label_gray",colorDict_RGB)
